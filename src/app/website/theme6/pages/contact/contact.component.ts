    ...
    try {
      ...
      if(this.contactForm.value.fullName && this.contactForm.value.mobileNumber && this.contactForm.value.message){
        ...
        Swal.fire({
          ...
          text:'We have received your message and would like to thank you for writing to us. If your inquiry is urgent, please use the telephone number listed below to talk to one of our staff members. Otherwise, we will reply by email as soon as possible',
